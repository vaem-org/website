<template>
  <section class="carousel" ref="carousel" v-swiper:mySwiper="swiperOptions" v-editable="blok" :style="{paddingBottom: 100/aspectRatio + '%'}">
      ...
      >
        ...
        <div class="body">
          <div class="text">
            ...
            <h3 v-if="slide.subTitle" class="hidden-xs-only" data-swiper-parallax="-300">{{
              slide.subTitle }}</h3>
            <p v-if="slide.text" class="hidden-sm-and-down" data-swiper-parallax="-500">{{
              slide.text }}</p>
            <ButtonLink
            ...
            >
              <slot v-if="slide.linkText">{{slide.linkText}}</slot>
            </ButtonLink>
          </div>
        </div>
      </div>
